    ...
    <div className="flex min-h-[100dvh] flex-col bg-background">
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Instant Review Updates</h3>
                      <p className="text-muted-foreground">
                        Get real-time notifications on your Slack channel whenever a new
                        review is opened, merged, or closed.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Tailor the bot's notifications to your team's preferences,
                        including which events to track and which channels to post in.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        The bot integrates seamlessly with your existing GitHub and
                        Slack workflows, requiring minimal setup and configuration.
                      </p>
                    </div>
                  </li>
                </ul>
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                Get Started with Review Corral
              </h2>
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Install the bot in just a few clicks and start streamlining your review
                process today.
              </p>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">
          &copy; 2024 Review Corral. All rights reserved.
        </p>
