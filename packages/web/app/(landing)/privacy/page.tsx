export default function PrivacyPage() {
  return <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <p className="text-sm text-gray-600 mb-8 italic">Last Updated: December 20, 2024</p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Introduction</h2>
          <p className="mb-4">
            Review Corral ("we," "our," or "us") is committed to protecting the privacy of users ("you" or "your")
            who access and use our Slack bot. This Privacy Policy explains how we collect, use, disclose, and
            safeguard your information when you use Review Corral.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li className="mb-2">Message content and metadata related to code review requests and responses</li>
          ...
          <p className="mb-3">We collect information that you voluntarily provide when:</p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-2">Facilitate code review processes within your Slack workspace</li>
            <li className="mb-2">Send notifications and reminders about pending reviews</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            Your data is stored securely on cloud servers with industry-standard encryption. We retain your data
            only for as long as necessary to provide our services and comply with legal obligations.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            through Slack or email. Your continued use of Review Corral after such modifications constitutes
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Review Corral operates through Slack and may integrate with other third-party services. Please
            review the privacy policies of these services, as we are not responsible for their privacy practices.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Review Corral is not intended for use by individuals under the age of 13. We do not knowingly
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            If you use Review Corral from outside [Your Country/Region], please be aware that your information
            may be transferred to, stored, and processed in [Your Country/Region] where our servers are located.
          </p>
        </section>
      </div>;
}
